"""Pit 18 · BEFORE — searches FAQ first regardless of intent.

Simulates the engineering-split design where docs live in 'web_docs' /
'file_docs' based on source; the retrieval path hits the wrong bucket for
entity-style lookups.
"""
